                                                ...
                                                <tr id="candidate_<?= $candidate->id ?>">
                                                    ...
                                                    <a href="<?= base_url("assets/uploads/career/") . htmlspecialchars($candidate->resume, ENT_QUOTES, 'UTF-8'); ?>" class="btn-sm btn-primary" target="_blank">
                                                        ...
                                                        <?php if ($controller_config['disable_candidate_delete'] != TRUE) : ?>
                                                            ...
                                                            <!-- The redirect function is now set to ajax by passing candidate id as data-redirect attribute. The function can find in assets\panel\dist\js\panel.js file. Find the 'trigger_delete_modal' event -->
                                                            <a href="#" class="btn-sm btn-danger trigger_delete_modal" data-title="Confirm" data-desc="Are you sure want to delete this?" data-redirect="<?= $candidate->id ?>" title='Delete'><i class="fas fa-trash-alt"></i></a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                        <?php
