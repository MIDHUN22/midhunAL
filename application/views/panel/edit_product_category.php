            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('panel/product_category/all') ?>">Category</a>
                        </li>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card card-dark">
                        ...
                        <form role="form" method="post"
                              action="<?= site_url('panel/product_category/edit/' . $id . '/' . $current_language->id) ?>"
                                ...
                                <div class="row">
                                        ...
                                        <?php if ($languages && count($languages) > 1 && $controller_config['disable_languages_category'] != TRUE): ?>
                                            <ul class="nav nav-tabs mb-4" id="news-content-below-tab" role="tablist">
                                                ...
                                                foreach ($languages as $language):
                                                    ?>
                                                    <li class="nav-item">
                                                        <a class="nav-link <?= in_array($language->id, $category_languages) && $language->id != $current_language->id ? ' bg-navy' : '' ?><?= $language->id == $current_language->id ? ' active bg-success' : '' ?>"
                                                           href="<?= base_url('panel/product_category/edit/' . $id . '/' . $language->id) ?>"
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input type="text"
                                               ...
                                               id="categoryTitle" placeholder="Title" name="categoryTitle"
                                               value="<?= set_value('categoryTitle', empty($category->title) ? '' : $category->title) ?>">
