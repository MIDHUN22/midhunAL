...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 20, 2023 at 09:01 AM
...
INSERT INTO `brand` (`id`, `brand_name`, `description`, `brand_img`, `link`, `language`, `language_parent`, `created_by`, `updated_by`, `created_at`, `updated_at`, `active`) VALUES
(1, 'test', 'test before try', '59882b7bef261a1d5e54c49d43779ec3.PNG', NULL, 1, NULL, 1, NULL, 1673502830, NULL, 0),
(2, 'test', 'testing', '73abc39d85ce8b6bc9129af04645d75c.jpeg', NULL, 1, 0, 1, 1, 1673585585, 1673592883, 0);
...
--
-- Table structure for table `enquiry_midhun`
--

DROP TABLE IF EXISTS `enquiry_midhun`;
CREATE TABLE IF NOT EXISTS `enquiry_midhun` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `enquiry_midhun`
--

INSERT INTO `enquiry_midhun` (`id`, `name`, `email`, `query`, `active`, `language`, `created_at`) VALUES
(1, 'demo 1', 'someone@example.com', 'demo enqiry', 1, 1, NULL);
...
--
-- Table structure for table `midhun`
--

DROP TABLE IF EXISTS `midhun`;
CREATE TABLE IF NOT EXISTS `midhun` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `midhun`
--

INSERT INTO `midhun` (`id`, `name`, `education`, `gender`, `phone`, `email`, `image`, `created_by`, `updated_by`, `created_at`, `updated_at`, `language`, `active`) VALUES
(1, 'midhun', 'mca123', 'male', '8547426068', 'midhunmchandhu@gmail.com', NULL, 1, 1, 1673524058, 1673595432, 1, 0),
(2, 'midhun 1', 'mca 1', 'male', '8547426067', 'midhunmchandu@gmail.com', 'c18b98d6e45f8435fe59f2148229c02d.jpg', 1, 1, 1673528262, 1673604640, 1, 1),
(3, 'Griffin', 'Tenetur tempo', 'Sunt deserunt eius', '8514689207', 'symiky@mailinator.com', 'f3d440f81b4d7baf69ee99dbd8a74c7e.jpg', 1, 1, 1673592363, 1673604604, 1, 1),
(4, 'midhun 3', 'mca3', 'male', '9865326598', 'examole@gmail.com', 'ca2d6e6cff19bd06053173f7cc7cd870.jpg', 1, NULL, 1673604708, NULL, 1, 1);
...
INSERT INTO `segments` (`id`, `title`, `short_description`, `description`, `image`, `created_by`, `updated_by`, `created_at`, `updated_at`, `languages`, `active`) VALUES
(1, 'Corporate Offices', 'Arclight provides one stop solutions to quality corporate offices right from space planning, design development, budgeting, project execution, office furniture supply, flooring solutions & IT infrastructure. We are well-versed with the authority regulations and work closely with client representatives or consultants to complete the fit-out jobs hassle free.', '', 'd4bf97d3ee1be162a4c9504c01368216.jpg', NULL, 1, NULL, 1674034696, 1, 1),
(2, 'test', 'test', 'test', NULL, 1, NULL, 1673954223, NULL, NULL, 0),
(3, 'Retail', 'At Arclight, we have a qualified team to execute retail outlets with absolute precision, quality within reasonable cost...', '', '82c307bc55bbe59214083bc339087fb0.jpg', 1, 1, 1673955062, 1674044537, NULL, 1),
(4, 'Hospitality', 'In hospitality industry, Arclight is focusing on mid-size packages & product supplies including guest room packages...', '', 'ee790d506de281025eaa48bc6f9f0406.jpg', 1, 1, 1673955110, 1674044567, NULL, 1),
(5, 'Food & Beverages', 'The challenges in F&B projects are many ranging from MEP design to Joinery and FF&E...', '', 'ccb9389c3fd3682225d8df5f5ba919dd.jpg', 1, 1, 1673955180, 1674044580, NULL, 1),
(6, 'Educational', 'Present optimized learning by transforming your classroom into an inviting,comfortable,and functional space...', '', '2d5b7d3c87dc2471c90af577d75ccac4.jpg', 1, 1, 1673955229, 1674044592, NULL, 1),
(7, 'Industrial & Commercial', 'Arclight industrial techinician provide one stop solutions for all industrial project with handful knowledge in erecting...', '', '932b184b73a4f37dcd7db73866599326.jpg', 1, 1, 1673955252, 1674044555, NULL, 1),
(8, 'test', 'yesy', '', NULL, 1, NULL, 1673958762, NULL, NULL, 0),
(9, 'teing image', 'testing', 'testing', '42d9b374a651c51d99740184c1e9c85d.png', 1, NULL, 1674021217, NULL, NULL, 0);
...
(1, '127.0.0.1', 'admin', '$2y$10$.dcUf4bc6CsigMee8H1Rc.sCwM9rfCuYjg.dNCKRDqsqXWPA1Wcby', 'admin@example.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1268889823, 1674016288, 1, 'Admin', 'Admin', NULL, NULL),
